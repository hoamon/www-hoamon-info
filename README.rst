Please go to ./docs-of-ho600-django-gae-default-trunk/ (目前只有中文版文件) to see documents.
...
go to
    ...
    release-1.0.2 documents: https://ho600-django-gae-default-trunk.readthedocs.org/en/release-1.0.2/ (目前只有中文版文件)
